...
public class IidStore {
    ...
    private String createTokenKey(String str, String str2) {
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m(STORE_KEY_TOKEN, str, STORE_KEY_SEPARATOR, str2);
    }
    ...
    private PublicKey parseKey(String str) {
        try {
            return KeyFactory.getInstance(RunnerBillingSecurity.KEY_FACTORY_ALGORITHM).generatePublic(new X509EncodedKeySpec(Base64.decode(str, 8)));
