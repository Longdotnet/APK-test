...
public class FirebaseInstallationServiceClient {
    ...
    private static String availableFirebaseOptions(String str, String str2, String str3) {
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m("Firebase options used while communicating with Firebase server APIs: ", str2, ", ", str3, TextUtils.isEmpty(str) ? "" : CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(", ", str));
    }
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            if (packageCertificateHashBytes != null) {
                return Hex.bytesToStringUppercase(packageCertificateHashBytes);
            }
    ...
    public static long parseTokenExpirationTimestamp(String str) {
        zzah.checkArgument(EXPIRATION_TIMESTAMP_PATTERN.matcher(str).matches(), PARSING_EXPIRATION_TIME_ERROR_MESSAGE);
    ...
    public InstallationResponse createFirebaseInstallation(String str, String str2, String str3, String str4, String str5) {
        ...
        URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1("projects/", str3, "/installations"));
        for (int i = 0; i <= 1; i++) {
    ...
    public void deleteFirebaseInstallation(String str, String str2, String str3, String str4) {
        URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(CoroutineAdapterKt$$ExternalSyntheticLambda0.m("projects/", str3, "/installations/", str2));
        int i = 0;
        while (i <= 1) {
    ...
    public TokenResult generateAuthToken(String str, String str2, String str3, String str4) {
        ...
        URL fullyQualifiedRequestUri = getFullyQualifiedRequestUri(CoroutineAdapterKt$$ExternalSyntheticLambda0.m("projects/", str3, "/installations/", str2, "/authTokens:generate"));
        for (int i = 0; i <= 1; i++) {
    ...
    private HttpURLConnection openHttpURLConnection(URL url, String str) throws FirebaseInstallationsException {
        try {
            ...
            httpURLConnection.addRequestProperty(ZRqOdXiy.WqEk, JSON_CONTENT_TYPE);
            ...
            if (heartBeatController != null) {
                try {
                    httpURLConnection.addRequestProperty(HEART_BEAT_HEADER, (String) WorkContinuation.await(heartBeatController.getHeartBeatsHeader()));
