...
public final class Component<T> {
    ...
    public static class Builder<T> {
        ...
        public Builder<T> add(Dependency dependency) {
            Preconditions.checkNotNull(dependency, JuorMn.khZtiLlvhQHQe);
    ...
    public /* synthetic */ Component(String str, Set set, Set set2, int i, int i2, ComponentFactory componentFactory, Set set3) {
    ...
    public static <T> Component<T> of(Class<T> cls, T t) {
        return builder(cls).factory(new Component$$ExternalSyntheticLambda0(t, 1)).build();
    }
    ...
    public static <T> Component<T> of(T t, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new Component$$ExternalSyntheticLambda0(t, 2)).build();
    }
}
