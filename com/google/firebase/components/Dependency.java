...
public final class Dependency {
    ...
    private static String describeInjection(int i) {
        ...
        throw new AssertionError(CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, "Unsupported injection: "));
    }
    ...
    public String toString() {
        ...
        int i = this.type;
        if (i == 1) {
            str = bUqMCsuPSX.RvRzZKnsd;
        } else {
            str = i == 0 ? "optional" : "set";
        }
        sb.append(str);
        sb.append(", injection=");
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m(sb, describeInjection(this.injection), "}");
    }
}
