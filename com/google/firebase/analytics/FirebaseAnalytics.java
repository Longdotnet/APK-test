...
public final class FirebaseAnalytics {
    ...
    private final ExecutorService zzb() {
        ...
        synchronized (FirebaseAnalytics.class) {
            try {
                if (this.zzc == null) {
                    this.zzc = new zza(0, 1, 30L, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
                }
    ...
    public Task getAppInstanceId() {
        try {
            return WorkContinuation.call(new zzb(this, 0), zzb());
        } catch (RuntimeException e) {
            this.zzb.zzB(5, "Failed to schedule task for getAppInstanceId", null, null, null);
            return WorkContinuation.forException(e);
        }
    }

    public String getFirebaseInstanceId() {
        try {
            return (String) WorkContinuation.await(FirebaseInstallations.getInstance().getId(), TimeUnit.MILLISECONDS);
    ...
    public Task getSessionId() {
        try {
            return WorkContinuation.call(new zzb(this, 1), zzb());
        } catch (RuntimeException e) {
