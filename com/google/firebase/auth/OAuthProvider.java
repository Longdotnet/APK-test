...
public class OAuthProvider extends FederatedAuthProvider {
    ...
    public static class Builder {
        ...
        public /* synthetic */ Builder(String str, FirebaseAuth firebaseAuth, zzad zzadVar) {
    ...
    public static class CredentialBuilder {
        ...
        public /* synthetic */ CredentialBuilder(String str, zzae zzaeVar) {
            this.zza = str;
        }
        ...
        public AuthCredential build() {
            ...
            com.google.android.gms.common.internal.zzah.checkNotEmpty(str, "Must specify a non-empty providerId");
    ...
    public /* synthetic */ OAuthProvider(Bundle bundle, zzaf zzafVar) {
        this.zza = bundle;
    }
    ...
    public static Builder newBuilder(String str, FirebaseAuth firebaseAuth) {
        ...
        if (!"facebook.com".equals(str) || zzyz.zzg(firebaseAuth.getApp())) {
    ...
    public final void zza(Activity activity) {
        Intent intent = new Intent(gZrKCJ.CZBVZJ);
        intent.setClass(activity, GenericIdpActivity.class);
        intent.setPackage(activity.getPackageName());
        intent.putExtras(this.zza);
        activity.startActivity(intent);
