...
public final class zzai {
    ...
    /* JADX WARN: Code duplicated, block: B:239:0x03a2  */
    public static Status zzb(String str, String str2) {
        byte b;
        int i;
        switch (str.hashCode()) {
            case -2130504259:
                ...
                break;
            case -2065866930:
                if (str.equals(xPQrbOSWiEdU.HPIqbVxjwDefI)) {
                    b = 28;
                } else {
                    b = -1;
                }
            ...
            case 1113992697:
                ...
                break;
            case 1141576252:
                if (str.equals(yzwzcWHcnH.yqSYVeFGmo)) {
                    b = 38;
                } else {
                    b = -1;
                }
        ...
        if (i == 17499) {
            if (str2 != null) {
                return new Status(FirebaseError.ERROR_INTERNAL_ERROR, CoroutineAdapterKt$$ExternalSyntheticLambda0.m(str, ":", str2));
            }
