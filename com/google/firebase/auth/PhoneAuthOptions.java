...
public final class PhoneAuthOptions {
    ...
    public static final class Builder {
        ...
        public PhoneAuthOptions build() {
            com.google.android.gms.common.internal.zzah.checkNotNull(this.zza, "FirebaseAuth instance cannot be null");
            com.google.android.gms.common.internal.zzah.checkNotNull(this.zzc, "You must specify an auto-retrieval timeout; please call #setTimeout()");
            com.google.android.gms.common.internal.zzah.checkNotNull(this.zzd, "You must specify callbacks on your PhoneAuthOptions. Please call #setCallbacks()");
            com.google.android.gms.common.internal.zzah.checkNotNull(this.zzf, "You must specify an Activity on your PhoneAuthOptions. Please call #setActivity()");
            ...
            if (multiFactorSession == null) {
                com.google.android.gms.common.internal.zzah.checkNotEmpty(this.zzb, "The given phoneNumber is empty. Please set a non-empty phone number with #setPhoneNumber()");
                com.google.android.gms.common.internal.zzah.checkArgument(!this.zzj, "You cannot require sms validation without setting a multi-factor session.");
                com.google.android.gms.common.internal.zzah.checkArgument(this.zzi == null, "A phoneMultiFactorInfo must be set for second factor sign-in.");
            } else if (((com.google.firebase.auth.internal.zzag) multiFactorSession).zze()) {
                com.google.android.gms.common.internal.zzah.checkNotEmpty(this.zzb);
                com.google.android.gms.common.internal.zzah.checkArgument(this.zzi == null, "Invalid MultiFactorSession - use the getSession method in MultiFactorResolver to get a valid sign-in session.");
            } else {
                com.google.android.gms.common.internal.zzah.checkArgument(this.zzi != null, "A phoneMultiFactorInfo must be set for second factor sign-in.");
                com.google.android.gms.common.internal.zzah.checkArgument(this.zzb == null, "A phone number must not be set for MFA sign-in. A PhoneMultiFactorInfo should be set instead.");
            }
