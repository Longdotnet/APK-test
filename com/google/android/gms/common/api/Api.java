...
public final class Api<O extends ApiOptions> {
    ...
    public <C extends Client> Api(String str, AbstractClientBuilder<C, O> abstractClientBuilder, ClientKey<C> clientKey) {
        zzah.checkNotNull(abstractClientBuilder, "Cannot construct an Api with a null ClientBuilder");
        zzah.checkNotNull(clientKey, "Cannot construct an Api with a null ClientKey");
        this.zac = str;
