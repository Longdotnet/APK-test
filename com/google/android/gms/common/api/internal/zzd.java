...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public final Map zzb = Collections.synchronizedMap(new ArrayMap());
    public int zzc = 0;
    public Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                ...
                backStackRecord.doAddOp(0, zzdVar2, "SupportLifecycleFragmentImpl");
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        if (map.containsKey(str)) {
            throw new IllegalArgumentException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1("LifecycleCallback with tag ", str, " already added to this fragment."));
        }
