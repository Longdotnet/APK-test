...
public final class CustomEventAdapter implements MediationBannerAdapter, MediationInterstitialAdapter, MediationNativeAdapter {
    public static final AdError zza = new AdError(0, "Could not instantiate custom event adapter", "com.google.android.gms.ads", null);
    ...
    public void requestBannerAd(Context context, MediationBannerListener mediationBannerListener, Bundle bundle, AdSize adSize, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        ...
        customEventBanner2.requestBannerAd(context, new GraphRequest.Companion(24), bundle.getString("parameter"), adSize, mediationAdRequest, bundle3);
    }
    ...
    public void requestInterstitialAd(Context context, MediationInterstitialListener mediationInterstitialListener, Bundle bundle, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        ...
        customEventInterstitial2.requestInterstitialAd(context, new GraphRequest.Companion(25), bundle.getString("parameter"), mediationAdRequest, bundle3);
    }
    ...
    public void requestNativeAd(Context context, MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        ...
        customEventNative2.requestNativeAd(context, new GraphRequest.Companion(26), bundle.getString("parameter"), nativeMediationAdRequest, bundle3);
    }
