...
final class zzi extends GmsClient {
    ...
    public final void disconnect(String str) {
        ...
        Log.w("GoogleAuthSvcClientImpl", strValueOf.length() != 0 ? "GoogleAuthServiceClientImpl disconnected with reason: ".concat(strValueOf) : new String("GoogleAuthServiceClientImpl disconnected with reason: "));
