...
final class zzdq {
    public static int zza(byte[] bArr, int i, zzdp zzdpVar) {
    ...
    public static int zzc(zzgb zzgbVar, byte[] bArr, int i, int i2, int i3, zzdp zzdpVar) {
    ...
    public static int zzd(zzgb zzgbVar, byte[] bArr, int i, int i2, zzdp zzdpVar) {
        int iZzk = i + 1;
        int i3 = bArr[i];
        if (i3 < 0) {
    ...
    public static int zze(zzgb<?> zzgbVar, int i, byte[] bArr, int i2, int i3, zzeu<?> zzeuVar, zzdp zzdpVar) {
    ...
    public static int zzf(byte[] bArr, int i, zzeu<?> zzeuVar, zzdp zzdpVar) {
    ...
    public static int zzi(int i, byte[] bArr, int i2, int i3, zzgq zzgqVar, zzdp zzdpVar) {
        if ((i >>> 3) == 0) {
            throw zzew.zza();
        }
        int i4 = i & 7;
