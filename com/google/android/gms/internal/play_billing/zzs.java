...
public interface zzs extends IInterface {
    ...
    void zzm(int i, String str, Bundle bundle, zzd zzdVar);

    void zzn(int i, String str, Bundle bundle, zzf zzfVar);

    void zzo(int i, String str, Bundle bundle, zzh zzhVar);

    void zzp(int i, String str, Bundle bundle, zzj zzjVar);

    void zzq(int i, String str, Bundle bundle, zzl zzlVar);

    void zzr(int i, String str, Bundle bundle, zzn zznVar);

    void zzs(int i, String str, Bundle bundle, zzp zzpVar);

    void zzt(int i, String str, Bundle bundle, zzu zzuVar);
