        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    Logger.getLogger(zzby.class.getName()).logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load ".concat(cls.getSimpleName()), (Throwable) e5);
                }
            }
            if (arrayList.size() == 1) {
            ...
            try {
                return (zzcd) cls.getMethod(MnHfHMYQDPUO.ntMaVnQUp, Collection.class).invoke(null, arrayList);
