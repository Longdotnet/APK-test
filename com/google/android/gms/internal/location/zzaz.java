...
public final class zzaz extends zzi {
    ...
    public final void zzL(LocationSettingsRequest locationSettingsRequest, BaseImplementation.ResultHolder<LocationSettingsResult> resultHolder, String str) {
        checkConnected();
        com.google.android.gms.common.internal.zzah.checkArgument(locationSettingsRequest != null, "locationSettingsRequest can't be null nor empty.");
        com.google.android.gms.common.internal.zzah.checkArgument(resultHolder != null, "listener can't be null.");
    ...
    public final void zzq(long j, PendingIntent pendingIntent) {
        ...
        com.google.android.gms.common.internal.zzah.checkArgument(j >= 0, "detectionIntervalMillis must be >= 0");
    ...
    public final void zzr(ActivityTransitionRequest activityTransitionRequest, PendingIntent pendingIntent, BaseImplementation.ResultHolder<Status> resultHolder) {
        checkConnected();
        com.google.android.gms.common.internal.zzah.checkNotNull(activityTransitionRequest, "activityTransitionRequest must be specified.");
        com.google.android.gms.common.internal.zzah.checkNotNull(pendingIntent, "PendingIntent must be specified.");
        com.google.android.gms.common.internal.zzah.checkNotNull(resultHolder, "ResultHolder not provided.");
    ...
    public final void zzv(GeofencingRequest geofencingRequest, PendingIntent pendingIntent, BaseImplementation.ResultHolder<Status> resultHolder) {
        checkConnected();
        com.google.android.gms.common.internal.zzah.checkNotNull(geofencingRequest, "geofencingRequest can't be null.");
        com.google.android.gms.common.internal.zzah.checkNotNull(pendingIntent, "PendingIntent must be specified.");
        com.google.android.gms.common.internal.zzah.checkNotNull(resultHolder, "ResultHolder not provided.");
    ...
    public final void zzw(com.google.android.gms.location.zzbq zzbqVar, BaseImplementation.ResultHolder<Status> resultHolder) {
        checkConnected();
        com.google.android.gms.common.internal.zzah.checkNotNull(zzbqVar, "removeGeofencingRequest can't be null.");
        com.google.android.gms.common.internal.zzah.checkNotNull(resultHolder, "ResultHolder not provided.");
    ...
    public final void zzy(List<String> list, BaseImplementation.ResultHolder<Status> resultHolder) {
        checkConnected();
        com.google.android.gms.common.internal.zzah.checkArgument(list != null && list.size() > 0, "geofenceRequestIds can't be null nor empty.");
        com.google.android.gms.common.internal.zzah.checkNotNull(resultHolder, "ResultHolder not provided.");
        ((zzam) getService()).zzf((String[]) list.toArray(new String[0]), new zzax(resultHolder), getContext().getPackageName());
    }

    public final Location zzz(String str) {
        return Hex.contains(getAvailableFeatures(), com.google.android.gms.location.zzu.zzc) ? this.zzf.zza(str) : this.zzf.zzb();
    }
}
