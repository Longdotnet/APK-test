...
public final class zzbc extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        CloseableKt.writeIBinder(parcel, 3, zzbdVar == null ? null : zzbdVar.asBinder());
        CloseableKt.writeParcelable(parcel, 4, this.zzd, i, false);
        com.google.android.gms.location.zzba zzbaVar = this.zze;
        CloseableKt.writeIBinder(parcel, 5, zzbaVar == null ? null : zzbaVar.asBinder());
        zzai zzaiVar = this.zzf;
        CloseableKt.writeIBinder(parcel, 6, zzaiVar != null ? zzaiVar.asBinder() : null);
