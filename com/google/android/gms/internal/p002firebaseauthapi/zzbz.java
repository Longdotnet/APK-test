...
public final class zzbz {
    ...
    public static synchronized zzns zzc(zznx zznxVar) {
        zzax zzaxVarZzb;
    ...
    public static synchronized zzaek zzd(zznx zznxVar) {
        zzax zzaxVarZzb;
        zzaxVarZzb = zzb(zznxVar.zzf());
        if (!((Boolean) zzd.get(zznxVar.zzf())).booleanValue()) {
            throw new GeneralSecurityException("newKey-operation not permitted for key type ".concat(String.valueOf(zznxVar.zzf())));
    ...
    @Deprecated
    public static Object zzf(zzns zznsVar) {
        String strZzf = zznsVar.zzf();
        return ((zzbd) zzb.get()).zza(strZzf).zzc(zznsVar.zze());
    }

    public static Object zzg(zzns zznsVar, Class cls) {
        return zzh(zznsVar.zzf(), zznsVar.zze(), cls);
    }

    public static Object zzh(String str, zzacc zzaccVar, Class cls) {
        return ((zzbd) zzb.get()).zzb(str, cls).zzc(zzaccVar);
    }

    public static Object zzi(String str, zzaek zzaekVar, Class cls) {
    ...
    public static synchronized void zzm(zzgx zzgxVar, zzgc zzgcVar, boolean z) {
        try {
    ...
    public static synchronized void zzn(zzgc zzgcVar, boolean z) {
        try {
            AtomicReference atomicReference = zzb;
            zzbd zzbdVar = new zzbd((zzbd) atomicReference.get());
            zzbdVar.zze(zzgcVar);
    ...
    public static synchronized void zzo(zzbv zzbvVar) {
        try {
            if (zzbvVar == null) {
            ...
            if (concurrentMap.containsKey(clsZzb)) {
                ...
                if (!zzbvVar.getClass().getName().equals(zzbvVar2.getClass().getName())) {
                    ...
                    throw new GeneralSecurityException("PrimitiveWrapper for primitive (" + clsZzb.getName() + ") is already registered to be " + zzbvVar2.getClass().getName() + ", cannot be re-registered with " + zzbvVar.getClass().getName());
                }
            }
    ...
    private static synchronized void zzp(String str, Map map, boolean z) {
        if (z) {
            try {
                ConcurrentMap concurrentMap = zzd;
    ...
    public static Object zzk(zzbu zzbuVar, Class cls) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m(ehgOP.orWnnawHUEV, zzbvVar.zza().toString(), ", got ", zzbuVar.zzc().toString()));
    }
}
