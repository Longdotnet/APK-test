...
public final class zzxe extends AsyncTask {
    ...
    public zzxe(String str, String str2, Intent intent, FirebaseApp firebaseApp, zzxg zzxgVar) {
        ...
        zzah.checkNotNull(intent);
        String stringExtra = intent.getStringExtra("com.google.firebase.auth.KEY_API_KEY");
        zzah.checkNotEmpty(stringExtra);
        Uri.Builder builderBuildUpon = Uri.parse(zzxgVar.zzc(stringExtra)).buildUpon();
    ...
    public final /* bridge */ /* synthetic */ Object doInBackground(Object[] objArr) {
        ...
        try {
            try {
                ...
                zza.e("Error getting project config. Failed with " + str + " " + responseCode, new Object[0]);
                return zzxd.zzb(str);
            } catch (zzvg e2) {
