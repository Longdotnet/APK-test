...
public final class zzxc {
    ...
    public static FirebaseAuthMultiFactorException zzc(FirebaseAuth firebaseAuth, zztm zztmVar, FirebaseUser firebaseUser) {
        ...
        List<MultiFactorInfo> listZzc = zztmVar.zzc();
        ...
        return new FirebaseAuthMultiFactorException(str, str2, new zzae(arrayList, zzag.zzb(zztmVar.zzc(), zztmVar.zzb()), firebaseAuth.getApp().getName(), zztmVar.zza(), (zzx) firebaseUser));
    }
    ...
    static {
        ...
        sparseArray.put(17064, new Pair("ERROR_INVALID_CERT_HASH", dLDI.ZHsvChbZXiMD));
        sparseArray.put(17065, new Pair("ERROR_WEB_STORAGE_UNSUPPORTED", nYVxXTZQ.jwRajXe));
        ...
        sparseArray.put(17072, new Pair(GsPcpBmONXh.bBck, "The provided tenant ID does not match the Auth instance's tenant ID."));
        ...
        sparseArray.put(17075, new Pair(UUFMQdNK.BqsJ, kBfGXgdfpo.yYBjATVaYZ));
        ...
        sparseArray.put(17081, new Pair("ERROR_MISSING_MULTI_FACTOR_SESSION", eoBKjVuj.ffcTTjNRBGZ));
        sparseArray.put(17082, new Pair(kBfGXgdfpo.rjDpECeTPtKg, "No second factor identifier is provided."));
    ...
    public static FirebaseException zza(Status status) {
        int statusCode = status.getStatusCode();
        String strZze = zze(zzf(statusCode), status);
        if (statusCode != 17020) {
            if (statusCode != 17021) {
                if (statusCode != 17051) {
                    if (statusCode != 17052) {
                        if (statusCode != 17057 && statusCode != 17058) {
                            switch (statusCode) {
                                ...
                                case 18009:
                                case 18010:
                                    return new FirebaseAuthException(zzd(statusCode), strZze);
                                ...
                                case FirebaseError.ERROR_ACCOUNT_EXISTS_WITH_DIFFERENT_CREDENTIAL /* 17012 */:
                                    return new FirebaseAuthUserCollisionException(zzd(statusCode), strZze);
                                ...
                                case 17080:
                                    return new FirebaseApiNotAvailableException(strZze);
                                case FirebaseError.ERROR_NO_SIGNED_IN_USER /* 17495 */:
                                    return new FirebaseNoSignedInUserException(zze(wsbWxekY.fpcZxrj, status));
                                case FirebaseError.ERROR_INTERNAL_ERROR /* 17499 */:
                                    return new FirebaseException(zze("An internal error has occurred.", status));
                                case 18006:
                                    return new zzw(zzd(statusCode), strZze);
                                case 18011:
                                    return new zzv(zzd(statusCode), strZze);
                                default:
                                    switch (statusCode) {
                                        case FirebaseError.ERROR_REQUIRES_RECENT_LOGIN /* 17014 */:
                                            return new FirebaseAuthRecentLoginRequiredException(zzd(statusCode), strZze);
                                        ...
                                        default:
                                            switch (statusCode) {
                                                ...
                                                case FirebaseError.ERROR_WEAK_PASSWORD /* 17026 */:
                                                    return new FirebaseAuthWeakPasswordException(zzd(statusCode), strZze, status.getStatusMessage());
                                                default:
                                                    switch (statusCode) {
                                                        ...
                                                        case 17029:
                                                        case 17030:
                                                            return new FirebaseAuthActionCodeException(zzd(statusCode), strZze);
                                                        case 17031:
                                                        case 17032:
                                                        case 17033:
                                                            return new FirebaseAuthEmailException(zzd(statusCode), strZze);
                                                        case 17034:
                                                        case 17035:
                                                            break;
                                                        default:
                        ...
                        return new FirebaseAuthWebException(zzd(statusCode), strZze);
                    }
                    return new FirebaseTooManyRequestsException(strZze);
                }
                return new FirebaseAuthInvalidCredentialsException(zzd(statusCode), strZze);
            }
            return new FirebaseAuthInvalidUserException(zzd(statusCode), strZze);
        }
