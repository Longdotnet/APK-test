...
public final class zzbh {
    ...
    public static final zzbh zzh(zzfq zzfqVar, zzap zzapVar) throws GeneralSecurityException {
    ...
    public final zzbh zzb() throws GeneralSecurityException {
        ...
        for (zzoe zzoeVar : this.zza.zzg()) {
            ...
            if (!(zzaxVarZza instanceof zzbw)) {
                throw new GeneralSecurityException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1("manager for key type ", strZzf, " is not a PrivateKeyManager"));
            }
    ...
    public final void zzf(zzbj zzbjVar, zzap zzapVar) throws GeneralSecurityException {
        byte[] bArr = new byte[0];
    ...
    public final void zzg(zzbj zzbjVar) throws GeneralSecurityException {
        for (zzoe zzoeVar : this.zza.zzg()) {
            if (zzoeVar.zzb().zzb() == zznr.UNKNOWN_KEYMATERIAL || zzoeVar.zzb().zzb() == zznr.SYMMETRIC || zzoeVar.zzb().zzb() == zznr.ASYMMETRIC_PRIVATE) {
                throw new GeneralSecurityException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m("keyset contains key material of type ", zzoeVar.zzb().zzb().name(), " for type url ", zzoeVar.zzb().zzf()));
            }
        }
