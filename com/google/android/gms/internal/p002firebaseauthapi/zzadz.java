...
final class zzadz extends zzabn implements RandomAccess, zzadk, zzaer {
    private static final zzadz zza;
    private long[] zzb;
    private int zzc;

    static {
        zzadz zzadzVar = new zzadz(new long[0], 0);
        zza = zzadzVar;
        zzadzVar.zzb();
    }
    ...
    private final String zzg(int i) {
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, this.zzc, "Index:", ", Size:");
    }
    ...
    public final /* synthetic */ void add(int i, Object obj) {
        ...
        if (i2 < jArr.length) {
            ...
            long[] jArr2 = new long[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i2, 3, 2, 1)];
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzc = (iZzc * 31) + zzadl.zzc(this.zzb[i]);
        }
        return iZzc;
    }
    ...
    public final /* bridge */ /* synthetic */ zzadk zzd(int i) {
        if (i >= this.zzc) {
            return new zzadz(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    public final void zzf(long j) {
        ...
        long[] jArr = this.zzb;
        if (i == jArr.length) {
            long[] jArr2 = new long[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i, 3, 2, 1)];
            System.arraycopy(jArr, 0, jArr2, 0, i);
            this.zzb = jArr2;
        }
        long[] jArr3 = this.zzb;
