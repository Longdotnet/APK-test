...
public final class zzbi {
    ...
    private final synchronized zzoe zzh(zzns zznsVar, zzoy zzoyVar) {
        zzod zzodVarZzc;
        int iZzg = zzg();
    ...
    private final synchronized zzoe zzi(zznx zznxVar) {
    ...
    @Deprecated
    public final synchronized int zza(zznx zznxVar, boolean z) {
        zzoe zzoeVarZzi;
    ...
    public final synchronized zzbi zzd(int i) {
