...
final class zzabr extends zzabn implements RandomAccess, zzadk, zzaer {
    ...
    public final /* synthetic */ void add(int i, Object obj) {
        ...
        if (i2 < zArr.length) {
            ...
            boolean[] zArr2 = new boolean[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i2, 3, 2, 1)];
    ...
    public final void zze(boolean z) {
        ...
        boolean[] zArr = this.zzb;
        if (i == zArr.length) {
            boolean[] zArr2 = new boolean[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i, 3, 2, 1)];
            System.arraycopy(zArr, 0, zArr2, 0, i);
            this.zzb = zArr2;
        }
