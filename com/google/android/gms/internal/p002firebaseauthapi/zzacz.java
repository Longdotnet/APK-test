...
final class zzacz extends zzabn implements RandomAccess, zzadk, zzaer {
    ...
    public final /* synthetic */ void add(int i, Object obj) {
        ...
        if (i2 < fArr.length) {
            ...
            float[] fArr2 = new float[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i2, 3, 2, 1)];
    ...
    public final void zze(float f) {
        ...
        float[] fArr = this.zzb;
        if (i == fArr.length) {
            float[] fArr2 = new float[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i, 3, 2, 1)];
            System.arraycopy(fArr, 0, fArr2, 0, i);
            this.zzb = fArr2;
        }
