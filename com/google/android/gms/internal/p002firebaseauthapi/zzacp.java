...
final class zzacp extends zzabn implements RandomAccess, zzadk, zzaer {
    ...
    public final /* synthetic */ void add(int i, Object obj) {
        ...
        if (i2 < dArr.length) {
            ...
            double[] dArr2 = new double[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i2, 3, 2, 1)];
    ...
    public final void zze(double d) {
        ...
        double[] dArr = this.zzb;
        if (i == dArr.length) {
            double[] dArr2 = new double[CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1(i, 3, 2, 1)];
            System.arraycopy(dArr, 0, dArr2, 0, i);
            this.zzb = dArr2;
        }
    ...
    private final String zzf(int i) {
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, this.zzc, "Index:", dLDI.eVO);
    }
