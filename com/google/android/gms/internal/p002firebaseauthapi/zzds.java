    ...
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 >= length) {
                ...
                long j24 = j23 >> 63;
                long j25 = ~j24;
                long j26 = (j20 & 67108863 & j25) | (j18 & j24);
            ...
            long j29 = (jZzb10 * j) + (jZzb9 * j2) + (jZzb8 * j3) + (jZzb7 * j4) + (jZzb6 * jZzb);
            long j30 = (jZzb10 * j2) + (jZzb9 * j3) + (jZzb8 * j4) + (jZzb7 * jZzb) + (jZzb6 * jZzb2) + (j29 >> 26);
            long j31 = (jZzb10 * j3) + (jZzb9 * j4) + (jZzb8 * jZzb) + (jZzb7 * jZzb2) + (jZzb6 * jZzb3) + (j30 >> 26);
            long j32 = (jZzb10 * j4) + (jZzb9 * jZzb) + (jZzb8 * jZzb2) + (jZzb7 * jZzb3) + (jZzb6 * jZzb4) + (j31 >> 26);
            long j33 = jZzb9 * jZzb2;
            long j34 = jZzb10 * jZzb;
            long j35 = j34 + j33 + (jZzb8 * jZzb3) + (jZzb7 * jZzb4) + (jZzb6 * jZzb5) + (j32 >> 26);
            long j36 = ((j35 >> 26) * 5) + (j29 & 67108863);
            j9 = j36 & 67108863;
            j6 = (j30 & 67108863) + (j36 >> 26);
            i2 += 16;
            j8 = j35 & 67108863;
            j7 = j32 & 67108863;
            j5 = j31 & 67108863;
