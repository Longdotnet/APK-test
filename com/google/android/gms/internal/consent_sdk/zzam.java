...
public final class zzam {
    ...
    public final void zzb(Context context) {
        ...
        if (atomicReference.get() == null) {
            try {
                atomicReference.set(Wrappers.packageManager(context).getApplicationInfo(128, context.getPackageName()).metaData);
    ...
    public final boolean zzd() {
        ...
        try {
            ...
            this.zzc.set(FirebaseAnalytics.class.getDeclaredMethod(MnHfHMYQDPUO.DMZMDkTTnKXjg, Map.class));
