            ...
            for (String str3 : map.keySet()) {
                if (!str3.equals("IABTCF_gdprApplies")) {
                    switch (str3.hashCode()) {
                        case -1926457382:
                            b = str3.equals("UMP_CoMoAdPersonalizationPurposeConsentStatus") ? (byte) 2 : (byte) -1;
                            break;
                        case -142866440:
                            b = str3.equals("UMP_CoMoAnalyticsStoragePurposeConsentStatus") ? (byte) 3 : (byte) -1;
                            break;
                        case 1068702385:
                            b = str3.equals("UMP_CoMoAdStoragePurposeConsentStatus") ? (byte) 0 : (byte) -1;
                            break;
                        case 1479307131:
                            b = str3.equals(iafHZUfOuHNwvy.cAUsdpvvGBZCFb) ? (byte) 1 : (byte) -1;
                            break;
                        default:
                            b = -1;
                            break;
