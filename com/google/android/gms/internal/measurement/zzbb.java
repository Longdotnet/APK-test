...
public final class zzbb {
    ...
    public static zzap zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        String str3 = dLDI.WsCNLecaNIRsqsq;
        switch (iHashCode) {
            case -1776922004:
                str2 = "toString";
        ...
        switch (b) {
            ...
            case 1:
                ...
                return zzb(zzaeVar, zzgVar, (zzao) zzapVarZzb2, Boolean.FALSE, Boolean.TRUE).zzc() != zzaeVar.zzc() ? zzap.zzl : zzap.zzk;
            case 2:
            ...
            case 4:
                ...
                while (itZzk3.hasNext()) {
                    ...
                    double d2 = iIntValue;
                    if (d2 >= dZza && zzh.zzl(zzaeVar.zze(iIntValue), zzapVarZzb5)) {
            ...
            case 14:
                ...
                for (int i4 = (int) dMax; i4 < dZzc2; i4++) {
            ...
            case 17:
                ...
                if (iZza < 0) {
                    iZza = Math.max(0, zzaeVar.zzc() + iZza);
