...
public final class zzgw extends zzgc implements zzhe {
    ...
    public /* synthetic */ zzgw(String str, int i, int i2, boolean z, boolean z2, zzhd zzhdVar, zzfvq zzfvqVar, boolean z3, zzgv zzgvVar) {
        super(true);
        this.zzd = str;
        this.zzb = i;
        this.zzc = i2;
    ...
    private final URL zzl(URL url, String str, zzgo zzgoVar) throws zzha {
        ...
        try {
            ...
            throw new zzha(CoroutineAdapterKt$$ExternalSyntheticLambda0.m("Disallowed cross-protocol redirect (", url.getProtocol(), " to ", protocol, ")"), zzgoVar, 2001, 1);
        } catch (MalformedURLException e) {
            throw new zzha(e, zzgoVar, 2001, 1);
        }
    }
    ...
    public final long zzb(com.google.android.gms.internal.ads.zzgo r27) {
        /*
        ...
        try {
            ...
            if (inputStream != null) {
                try {
                    ...
                    zzgo zzgoVar = this.zzg;
                    String str = zzex.zza;
                    throw new zzha(e, zzgoVar, 2000, 3);
                }
            }
            this.zzi = null;
            zzm();
