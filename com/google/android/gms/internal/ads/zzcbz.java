...
public final class zzcbz extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzcbx {
    ...
    public final void run() {
        ...
        zzbcv zzbcvVar = zzbde.zzbw;
        com.google.android.gms.ads.internal.client.zzbd zzbdVar = com.google.android.gms.ads.internal.client.zzbd.zza;
        int iZzl = zzl(35633, !((String) zzbdVar.zzd.zzb(zzbcvVar)).equals(zzbcvVar.zzl()) ? (String) zzbdVar.zzd.zzb(zzbcvVar) : "attribute highp vec3 aPosition;varying vec3 pos;void main() {  gl_Position = vec4(aPosition, 1.0);  pos = aPosition;}");
        if (iZzl == 0) {
            iGlCreateProgram = 0;
        } else {
            zzbcv zzbcvVar2 = zzbde.zzbx;
            int iZzl2 = zzl(35632, !((String) zzbdVar.zzd.zzb(zzbcvVar2)).equals(zzbcvVar2.zzl()) ? (String) zzbdVar.zzd.zzb(zzbcvVar2) : "#extension GL_OES_EGL_image_external : require\n#define INV_PI 0.3183\nprecision highp float;varying vec3 pos;uniform samplerExternalOES uSplr;uniform mat3 uVMat;uniform float uFOVx;uniform float uFOVy;void main() {  vec3 ray = vec3(pos.x * tan(uFOVx), pos.y * tan(uFOVy), -1);  ray = (uVMat * ray).xyz;  ray = normalize(ray);  vec2 texCrd = vec2(    0.5 + atan(ray.x, - ray.z) * INV_PI * 0.5, acos(ray.y) * INV_PI);  gl_FragColor = vec4(texture2D(uSplr, texCrd).xyz, 1.0);}");
            if (iZzl2 == 0) {
                iGlCreateProgram = 0;
            } else {
        ...
        zzh("texParameteri");
        int iGlGetUniformLocation = GLES20.glGetUniformLocation(this.zzq, oKjScaD.RtyFdZMg);
        ...
        if (!z || i4 == 0) {
            ...
            com.google.android.gms.ads.internal.zzv.zza.zzi.zzw(new Throwable(strConcat), "SphericalVideoProcessor.run.1");
            zzg();
            this.zzu.countDown();
            return;
        }
        ...
        try {
            try {
                ...
                while (!this.zzB) {
                    ...
                    if (zzcbyVar.zze(fArr)) {
                        if (Float.isNaN(this.zzj)) {
                            ...
                            float f4 = fArr[1];
                            float f5 = fArr2[1];
                            float f6 = (fArr[c] * f) + (f4 * f5) + (f2 * f3);
                            float f7 = (fArr[5] * f) + (fArr[i] * f3) + (fArr[4] * f5);
                            float f8 = (fArr[c2] * f) + (fArr[6] * f3) + (fArr[7] * f5);
                    ...
                    if (this.zzA) {
                        ...
                        if (i6 > i7) {
                            ...
                            GLES20.glUniform1f(iGlGetUniformLocation2, (i6 * 0.87266463f) / i7);
                ...
                com.google.android.gms.ads.internal.zzv.zza.zzi.zzw(th2, "SphericalVideoProcessor.run.2");
            }
            this.zzb.zzd();
