...
public final class zzebh {
    public static int zza(SQLiteDatabase sQLiteDatabase, int i) {
        ...
        if (cursorZzg.getCount() > 0) {
            ...
            i2 = cursorZzg.getInt(cursorZzg.getColumnIndexOrThrow(FirebaseAnalytics.Param.VALUE));
        }
        cursorZzg.close();
        return i2;
    }
    ...
    public static long zzb(SQLiteDatabase sQLiteDatabase, int i) {
        ...
        if (cursorZzg.getCount() > 0) {
            cursorZzg.moveToNext();
            j = cursorZzg.getLong(cursorZzg.getColumnIndexOrThrow(FirebaseAnalytics.Param.VALUE));
        } else {
            j = 0;
        }
        cursorZzg.close();
    ...
    public static void zzd(SQLiteDatabase sQLiteDatabase) {
        ...
        contentValues.put(FirebaseAnalytics.Param.VALUE, (Long) 0L);
    ...
    public static void zze(SQLiteDatabase sQLiteDatabase) {
        ...
        zzi(sQLiteDatabase, bUqMCsuPSX.xOAWBDshrSskv, 0);
        zzi(sQLiteDatabase, GsPcpBmONXh.AUKE, 0);
    }
}
