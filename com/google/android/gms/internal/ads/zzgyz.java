...
public abstract class zzgyz {
    public static zzgyr zzb(Class cls) {
        ...
        if (cls.equals(zzgyr.class)) {
            ...
            if (!cls.getPackage().equals(zzgyz.class.getPackage())) {
        ...
        try {
            try {
                try {
                    return (zzgyr) cls.cast(((zzgyz) Class.forName(str, true, classLoader).getConstructor(null).newInstance(null)).zza());
            ...
            while (it.hasNext()) {
                try {
                    ...
                    Logger.getLogger(zzgym.class.getName()).logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load ".concat(cls.getSimpleName()), (Throwable) e5);
                }
            }
            if (arrayList.size() == 1) {
