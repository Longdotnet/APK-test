...
public final class PluginProtos {
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessage implements CodeGeneratorRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder> implements CodeGeneratorRequestOrBuilder {
            ...
            public DescriptorProtos.FileDescriptorProto.Builder getSourceFileDescriptorsBuilder(int i) {
                return (DescriptorProtos.FileDescriptorProto.Builder) getSourceFileDescriptorsFieldBuilder().getBuilder(i);
            }
            ...
            public DescriptorProtos.FileDescriptorProto.Builder addSourceFileDescriptorsBuilder(int i) {
                return (DescriptorProtos.FileDescriptorProto.Builder) getSourceFileDescriptorsFieldBuilder().addBuilder(i, DescriptorProtos.FileDescriptorProto.getDefaultInstance());
            }
            ...
            public Builder mergeFrom(CodeGeneratorRequest codeGeneratorRequest) {
                ...
                if (this.protoFileBuilder_ == null) {
                    ...
                    if (!this.protoFileBuilder_.isEmpty()) {
                        ...
                        this.protoFile_ = codeGeneratorRequest.protoFile_;
                        this.bitField0_ &= -5;
                        this.protoFileBuilder_ = GeneratedMessage.alwaysUseFieldBuilders ? getProtoFileFieldBuilder() : null;
                    }
                }
                if (this.sourceFileDescriptorsBuilder_ == null) {
                    ...
                    if (!this.sourceFileDescriptorsBuilder_.isEmpty()) {
                        ...
                        this.sourceFileDescriptors_ = codeGeneratorRequest.sourceFileDescriptors_;
                        this.bitField0_ &= -9;
                        this.sourceFileDescriptorsBuilder_ = GeneratedMessage.alwaysUseFieldBuilders ? getSourceFileDescriptorsFieldBuilder() : null;
                    }
                }
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", CodeGeneratorRequest.class.getName());
        ...
        public int hashCode() {
            ...
            if (getFileToGenerateCount() > 0) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getFileToGenerateList().hashCode();
            }
            if (hasParameter()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53) + getParameter().hashCode();
            }
            if (getProtoFileCount() > 0) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 15, 53) + getProtoFileList().hashCode();
            }
            if (getSourceFileDescriptorsCount() > 0) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 17, 53) + getSourceFileDescriptorsList().hashCode();
            }
            if (hasCompilerVersion()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 3, 53) + getCompilerVersion().hashCode();
            }
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessage implements CodeGeneratorResponseOrBuilder {
        ...
        public enum Feature implements ProtocolMessageEnum {
            ...
            static {
                RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Feature.class.getName());
        ...
        public static final class File extends GeneratedMessage implements FileOrBuilder {
            ...
            static {
                RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", File.class.getName());
            ...
            public int hashCode() {
                ...
                int iHashCode = getDescriptor().hashCode() + 779;
                if (hasName()) {
                    iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getName().hashCode();
                }
                if (hasInsertionPoint()) {
                    iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53) + getInsertionPoint().hashCode();
                }
                if (hasContent()) {
                    iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 15, 53) + getContent().hashCode();
                }
                if (hasGeneratedCodeInfo()) {
                    iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 16, 53) + getGeneratedCodeInfo().hashCode();
                }
                int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
                this.memoizedHashCode = iHashCode2;
                return iHashCode2;
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", CodeGeneratorResponse.class.getName());
        ...
        public int hashCode() {
            ...
            int iHashCode = getDescriptor().hashCode() + 779;
            if (hasError()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getError().hashCode();
            }
            if (hasSupportedFeatures()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53) + Internal.hashLong(getSupportedFeatures());
            }
            if (hasMinimumEdition()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 3, 53) + getMinimumEdition();
            }
            if (hasMaximumEdition()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 4, 53) + getMaximumEdition();
            }
            if (getFileCount() > 0) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 15, 53) + getFileList().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
    ...
    public static final class Version extends GeneratedMessage implements VersionOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Version.class.getName());
        ...
        public int hashCode() {
            ...
            int iHashCode = getDescriptor().hashCode() + 779;
            if (hasMajor()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getMajor();
            }
            if (hasMinor()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53) + getMinor();
            }
            if (hasPatch()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 3, 53) + getPatch();
            }
            if (hasSuffix()) {
                iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 4, 53) + getSuffix().hashCode();
            }
            int iHashCode2 = getUnknownFields().hashCode() + (iHashCode * 29);
            this.memoizedHashCode = iHashCode2;
            return iHashCode2;
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", PluginProtos.class.getName());
