...
public abstract class CodedInputStream {
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        public /* synthetic */ ArrayDecoder(byte[] bArr, int i, int i2, boolean z) {
            this(bArr, i, i2, z);
        }
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public /* synthetic */ IterableDirectByteBufferDecoder(Iterable iterable, int i, boolean z) {
            this(iterable, i, z);
        }
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        public /* synthetic */ StreamDecoder(InputStream inputStream, int i) {
            this(inputStream, i);
        }
        ...
        private boolean tryRefillBuffer(int i) throws InvalidProtocolBufferException {
            ...
            if (i2 + i <= this.bufferSize) {
                throw new IllegalStateException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, "refillBuffer() called when ", bUqMCsuPSX.WgQzJfa));
            }
    ...
    public static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        public /* synthetic */ UnsafeDirectNioDecoder(ByteBuffer byteBuffer, boolean z) {
            this(byteBuffer, z);
        }
    ...
    public /* synthetic */ CodedInputStream() {
        this();
    }
    ...
    public final int setRecursionLimit(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, "Recursion limit cannot be negative: "));
        }
    ...
    public final int setSizeLimit(int i) {
        if (i < 0) {
            throw new IllegalArgumentException(CoroutineAdapterKt$$ExternalSyntheticLambda0.m(i, "Size limit cannot be negative: "));
        }
