...
final class ArrayDecoders {
    ...
    public static int decodeGroupField(Schema schema, byte[] bArr, int i, int i2, int i3, Registers registers) throws InvalidProtocolBufferException {
    ...
    public static int decodeGroupList(Schema schema, int i, byte[] bArr, int i2, int i3, Internal.ProtobufList<?> protobufList, Registers registers) throws InvalidProtocolBufferException {
        int i4 = (i & (-8)) | 4;
    ...
    public static int decodeUnknownField(int i, byte[] bArr, int i2, int i3, UnknownFieldSetLite unknownFieldSetLite, Registers registers) throws InvalidProtocolBufferException {
        ...
        while (i2 < i3) {
            ...
            i7 = i8;
            i2 = decodeUnknownField(i8, bArr, iDecodeVarint33, i3, unknownFieldSetLiteNewInstance, registers);
        }
    ...
    public static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i, int i2, int i3, Registers registers) throws InvalidProtocolBufferException {
