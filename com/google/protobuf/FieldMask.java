...
public final class FieldMask extends GeneratedMessage implements FieldMaskOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", FieldMask.class.getName());
    ...
    public int hashCode() {
        ...
        if (getPathsCount() > 0) {
            iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getPathsList().hashCode();
        }
