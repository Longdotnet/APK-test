...
public final class Method extends GeneratedMessage implements MethodOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Method.class.getName());
    ...
    public int hashCode() {
        ...
        if (getOptionsCount() > 0) {
            iHashBoolean = getOptionsList().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashBoolean, 37, 6, 53);
        }
        int iHashCode = getUnknownFields().hashCode() + ((CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashBoolean, 37, 7, 53) + this.syntax_) * 29);
