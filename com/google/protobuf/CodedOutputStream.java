...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i) {
            ...
            while ((i & (-128)) != 0) {
                ...
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr3, i4, (byte) ((i | 128) & 255));
                i >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j) {
            ...
            while ((j & (-128)) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                UnsafeUtil.putByte(bArr3, i3, (byte) ((((int) j) | 128) & 255));
                j >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i4 = this.position;
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public ArrayEncoder(byte[] bArr, int i, int i2) {
            ...
            if ((i | i2 | (bArr.length - i3)) < 0) {
                ...
                StringBuilder sbM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m("Array range is invalid. Buffer.length=", bArr.length, ", offset=", i, ", length=");
                sbM.append(i2);
        ...
        public final void writeUInt32NoTag(int i) throws OutOfSpaceException {
            while ((i & (-128)) != 0) {
                try {
                    ...
                    throw new OutOfSpaceException(this.position, this.limit, 1, (Throwable) e);
                }
            }
            byte[] bArr2 = this.buffer;
            int i3 = this.position;
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        public OutOfSpaceException(String str) {
            super(CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }
        ...
        public OutOfSpaceException(String str, Throwable th) {
            super(CoroutineAdapterKt$$ExternalSyntheticLambda0.m$1("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws OutOfSpaceException {
            while ((i & (-128)) != 0) {
                try {
                    this.buffer.put((byte) ((i | 128) & 255));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long j) throws OutOfSpaceException {
            while (((-128) & j) != 0) {
                try {
                    this.buffer.put((byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt32NoTag(int i) throws OutOfSpaceException {
            ...
            while (true) {
                ...
                if ((i & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((i | 128) & 255));
                    i >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long j) throws OutOfSpaceException {
            ...
            if (this.position <= this.oneVarintLimit) {
                while ((j2 & (-128)) != 0) {
                    long j3 = this.position;
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((((int) j2) | 128) & 255));
                    j2 >>>= 7;
                }
            ...
            while (true) {
                ...
                if ((j2 & (-128)) == 0) {
                    ...
                    this.position = j5 + 1;
                    UnsafeUtil.putByte(j5, (byte) ((((int) j2) | 128) & 255));
                    j2 >>>= 7;
                }
            }
        }
    ...
    public /* synthetic */ CodedOutputStream() {
        this();
    }
    ...
    public static CodedOutputStream newInstance(ByteBuffer byteBuffer) {
        ...
        throw new IllegalArgumentException(yzwzcWHcnH.QDEtcwsMGskvw);
    }
