...
public final class Option extends GeneratedMessage implements OptionOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Option.class.getName());
    ...
    public int hashCode() {
        ...
        if (hasValue()) {
            iHashCode = getValue().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53);
        }
