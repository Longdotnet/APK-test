...
public final class UnknownFieldSet implements MessageLite {
    ...
    public static final class Builder implements MessageLite.Builder {
        ...
        public Builder addField(int i, Field field) {
            ...
            throw new IllegalArgumentException(i + PZmDzEagKNdW.HdwwdJMya);
        }
        ...
        public Builder mergeLengthDelimitedField(int i, ByteString byteString) {
            ...
            throw new IllegalArgumentException(i + DYYbQc.CdQzHTUCrggACae);
        }
        ...
        public Builder m108clone() {
            Builder builderNewBuilder = UnknownFieldSet.newBuilder();
            for (Map.Entry<Integer, Field.Builder> entry : this.fieldBuilders.entrySet()) {
                builderNewBuilder.fieldBuilders.put(entry.getKey(), entry.getValue().m109clone());
            }
            return builderNewBuilder;
        }
    ...
    public /* synthetic */ UnknownFieldSet(TreeMap treeMap) {
        this(treeMap);
    }
