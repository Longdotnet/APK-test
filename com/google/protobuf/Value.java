...
public final class Value extends GeneratedMessage implements ValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Value.class.getName());
    ...
    public int hashCode() {
        ...
        switch (this.kindCase_) {
            case 1:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53);
                nullValueValue = getNullValueValue();
                break;
            case 2:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53);
                nullValueValue = Internal.hashLong(Double.doubleToLongBits(getNumberValue()));
                break;
            case 3:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 3, 53);
                nullValueValue = getStringValue().hashCode();
                break;
            case 4:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 4, 53);
                nullValueValue = Internal.hashBoolean(getBoolValue());
                break;
            case 5:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 5, 53);
                nullValueValue = getStructValue().hashCode();
                break;
            case 6:
                iM = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 6, 53);
    ...
    public static final class Builder extends GeneratedMessage.Builder<Builder> implements ValueOrBuilder {
        ...
        public ListValue getListValue() {
            ...
            return this.kindCase_ == 6 ? (ListValue) singleFieldBuilder.getMessage() : ListValue.getDefaultInstance();
        }
        ...
        public ListValueOrBuilder getListValueOrBuilder() {
            ...
            if (i != 6 || (singleFieldBuilder = this.listValueBuilder_) == null) {
                return i == 6 ? (ListValue) this.kind_ : ListValue.getDefaultInstance();
            }
        ...
        public Struct getStructValue() {
            ...
            return this.kindCase_ == 5 ? (Struct) singleFieldBuilder.getMessage() : Struct.getDefaultInstance();
        }
        ...
        public StructOrBuilder getStructValueOrBuilder() {
            ...
            if (i != 5 || (singleFieldBuilder = this.structValueBuilder_) == null) {
                return i == 5 ? (Struct) this.kind_ : Struct.getDefaultInstance();
            }
