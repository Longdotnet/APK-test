...
public final class ListValue extends GeneratedMessage implements ListValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", ListValue.class.getName());
    ...
    public int hashCode() {
        ...
        if (getValuesCount() > 0) {
            iHashCode = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 1, 53) + getValuesList().hashCode();
        }
