...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final class ArraysByteArrayCopier implements ByteArrayCopier {
        ...
        public /* synthetic */ ArraysByteArrayCopier() {
            this();
        }
    }
    ...
    public static final class CodedBuilder {
        ...
        public /* synthetic */ CodedBuilder(int i) {
            this(i);
        }
    ...
    public static abstract class LeafByteString extends ByteString {
        ...
        public /* synthetic */ LeafByteString() {
            this();
        }
    ...
    public static final class SystemByteArrayCopier implements ByteArrayCopier {
        ...
        public /* synthetic */ SystemByteArrayCopier() {
            this();
        }
    }
    ...
    private static int extractHexDigit(String str, int i) {
        ...
        StringBuilder sbM21m = CoroutineAdapterKt$$ExternalSyntheticLambda0.m21m("Invalid hexString ", str, " must only contain [0-9a-fA-F] but contained ");
        sbM21m.append(str.charAt(i));
        sbM21m.append(" at index ");
        sbM21m.append(i);
        throw new NumberFormatException(sbM21m.toString());
    }

    public static ByteString fromHex(String str) {
        if (str.length() % 2 != 0) {
            StringBuilder sbM21m = CoroutineAdapterKt$$ExternalSyntheticLambda0.m21m("Invalid hexString ", str, " of length ");
            sbM21m.append(str.length());
            sbM21m.append(" must be even.");
            throw new NumberFormatException(sbM21m.toString());
        }
    ...
    private String truncateAndEscapeForDisplay() {
        return size() <= 50 ? TextFormatEscaper.escapeBytes(this) : CoroutineAdapterKt$$ExternalSyntheticLambda0.m(new StringBuilder(), TextFormatEscaper.escapeBytes(substring(0, 47)), "...");
    }
    ...
    public static final class Output extends OutputStream {
        ...
        public Output(int i) {
            ...
            throw new IllegalArgumentException(eoBKjVuj.FKkN);
        }
    ...
    public final String toString() {
        ...
        sb.append(size);
        sb.append(" contents=\"");
        return CoroutineAdapterKt$$ExternalSyntheticLambda0.m(sb, strTruncateAndEscapeForDisplay, "\">");
    }
