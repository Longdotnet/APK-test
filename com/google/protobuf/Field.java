...
public final class Field extends GeneratedMessage implements FieldOrBuilder {
    ...
    public enum Cardinality implements ProtocolMessageEnum {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Cardinality.class.getName());
    ...
    public enum Kind implements ProtocolMessageEnum {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Kind.class.getName());
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Field.class.getName());
    ...
    public int hashCode() {
        ...
        if (getOptionsCount() > 0) {
            iHashBoolean = getOptionsList().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashBoolean, 37, 9, 53);
        }
        int iHashCode = getUnknownFields().hashCode() + ((getDefaultValue().hashCode() + ((((getJsonName().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashBoolean, 37, 10, 53)) * 37) + 11) * 53)) * 29);
