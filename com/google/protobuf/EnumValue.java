...
public final class EnumValue extends GeneratedMessage implements EnumValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", EnumValue.class.getName());
    ...
    public int hashCode() {
        ...
        if (getOptionsCount() > 0) {
            number = CoroutineAdapterKt$$ExternalSyntheticLambda0.m(number, 37, 3, 53) + getOptionsList().hashCode();
        }
