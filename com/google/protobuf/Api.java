...
public final class Api extends GeneratedMessage implements ApiOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", Api.class.getName());
    ...
    public int hashCode() {
        ...
        if (getMethodsCount() > 0) {
            iHashCode = getMethodsList().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 2, 53);
        }
        if (getOptionsCount() > 0) {
            iHashCode = getOptionsList().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 3, 53);
        }
        int iHashCode2 = getVersion().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode, 37, 4, 53);
        if (hasSourceContext()) {
            iHashCode2 = getSourceContext().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode2, 37, 5, 53);
        }
        if (getMixinsCount() > 0) {
            iHashCode2 = getMixinsList().hashCode() + CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode2, 37, 6, 53);
        }
        int iHashCode3 = getUnknownFields().hashCode() + ((CoroutineAdapterKt$$ExternalSyntheticLambda0.m(iHashCode2, 37, 7, 53) + this.syntax_) * 29);
