...
public final class TypeProto {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 29, 5, "", TypeProto.class.getName());
        ...
        String str = PZmDzEagKNdW.TRpO;
        internal_static_google_protobuf_EnumValue_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(descriptor5, new String[]{str, "Number", "Options"});
        Descriptors.Descriptor descriptor6 = getDescriptor().getMessageTypes().get(4);
        internal_static_google_protobuf_Option_descriptor = descriptor6;
        internal_static_google_protobuf_Option_fieldAccessorTable = new GeneratedMessage.FieldAccessorTable(descriptor6, new String[]{str, "Value"});
