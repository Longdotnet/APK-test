...
public abstract class HashUtils {
    ...
    public static final String computeChecksum(String str) throws IOException {
        int i;
    ...
    public static final String computeChecksumWithPackageManager(Context context) throws CertificateException {
        ...
        try {
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(HashUtils.class.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.facebook.appevents.internal.HashUtils$computeChecksumWithPackageManager$listener$1
                ...
                public final Object invoke(Object obj2, Method method, Object[] objects) {
                    ...
                    try {
                                ...
                                for (Object obj4 : (List) obj3) {
                                    if (obj4 != null) {
                                        ...
                                        if (method2.invoke(obj4, null) == null && Intrinsics.areEqual(method3.invoke(obj4, null), obj)) {
                                            ...
                                            Object objInvoke = method4.invoke(obj4, null);
                                            if (objInvoke == null) {
                                                throw new NullPointerException("null cannot be cast to non-null type kotlin.ByteArray");
                                            }
                                            initializedLazyImpl.value = new BigInteger(1, (byte[]) objInvoke).toString(16);
                                            reentrantLock2.lock();
                                            try {
                        ...
                        Log.d("HashUtils", "Can't fetch checksum.", th);
                    }
                    return null;
                }
            });
            ...
            String str = (String) initializedLazyImpl.value;
