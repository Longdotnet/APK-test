...
public abstract class Huffman {
    ...
    public final class Node {
        ...
        public byte get(int i, int i2) {
            return ((byte[][]) this.children)[i2][i];
        }

        public void set(int i, int i2, int i3) {
            ((byte[][]) this.children)[i2][i] = (byte) i3;
        }
        ...
        public String toString() {
            switch (this.$r8$classId) {
                case 1:
                    int i = this.symbol;
                    int i2 = this.terminalBitCount;
                    StringBuilder sb = new StringBuilder((i * 2 * i2) + 2);
                    for (int i3 = 0; i3 < i2; i3++) {
                        byte[] bArr = ((byte[][]) this.children)[i3];
        ...
        public void set(int i, int i2, boolean z) {
            ((byte[][]) this.children)[i2][i] = z ? (byte) 1 : (byte) 0;
        }
        ...
        public Node(int i, int i2, int i3) {
            ...
            switch (i3) {
                case 1:
                    this.children = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, i2, i);
                    this.symbol = i;
