...
internal static class InputMatrixProbeReplayRegression
{
    ...
    internal static void Verify()
    {
        ...
        {
            // Module initializers share process-global diagnostic state with the rest of the
            // recovery harness. Never leak replay-test evidence into later authorization/input
            // checks; production probes populate the registry themselves.
            RobloxInputMatrixProbeEvidenceRegistry.ResetForDiagnostics();
        }
    }
}
