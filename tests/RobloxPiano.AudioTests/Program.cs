...
var tests = new (string Name, Action Run)[]
{
    ...
    ("weak third-harmonic duplicate is suppressed", BasicPitchHarmonicSuppressionRegression.WeakThirdHarmonicIsSuppressed),
    ("musical octave doubling is protected", BasicPitchHarmonicSuppressionRegression.MusicalOctaveDoublingIsProtected),
    ("strong harmonic interval is preserved", BasicPitchHarmonicSuppressionRegression.StrongHarmonicIntervalIsPreservedAsIntentionalHarmony),
    ("offset harmony is preserved", BasicPitchHarmonicSuppressionRegression.OffsetHarmonyIsPreserved),
    ("short-overlap harmony is preserved", BasicPitchHarmonicSuppressionRegression.ShortOverlapIsPreserved),
    ("suppressed candidates cannot become anchors", BasicPitchHarmonicSuppressionRegression.SuppressedCandidateCannotBecomeAnchor),
    ("disabled suppression policy is identity", BasicPitchHarmonicSuppressionRegression.DisabledPolicyIsIdentity),
    ("harmonic suppression honors pre-cancellation", BasicPitchHarmonicSuppressionRegression.PreCancellationStopsBeforeSuppression),
    ("harmonic suppression policy fails closed", BasicPitchHarmonicSuppressionRegression.InvalidPolicyFailsClosed),
