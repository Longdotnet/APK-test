...
public enum CampaignStatus { Queued, Running, Completed, Partial }
...
public sealed record CreateCampaignRequest(string Target, int Quantity, long StartingFollowers = 0);
