...
public abstract class ColorUtils {
    ...
    public static int compositeColors(int i, int i2) {
        ...
        return Color.argb(i3, compositeComponent(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), compositeComponent(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), compositeComponent(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }
