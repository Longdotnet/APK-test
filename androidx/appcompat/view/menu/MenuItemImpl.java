...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public final View getActionView() {
        ...
        View viewOnCreateActionView = actionProviderWrapper.mInner.onCreateActionView(this);
    ...
    public final Drawable getIcon() {
        ...
        Drawable drawable2 = Headers.Companion.getDrawable(this.mMenu.mContext, i);
        this.mIconResId = 0;
    ...
    public final boolean isVisible() {
        ...
        return (this.mFlags & 8) == 0 && this.mActionProvider.mInner.isVisible();
    }
    ...
    public final SupportMenuItem setSupportActionProvider(MenuItemWrapperICS.ActionProviderWrapper actionProviderWrapper) {
        ...
        if (actionProviderWrapper2 != null) {
            actionProviderWrapper2.mListener = new AccessTokenCache(this, 2);
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        throw new UnsupportedOperationException(wsbWxekY.wdHhW);
    }
