...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(2);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        Drawable drawable2 = this.mBackground;
        boolean z = this.mIsSplit;
        return (drawable == drawable2 && !z) || (drawable == this.mStackedBackground && this.mIsStacked) || ((drawable == this.mSplitBackground && z) || super.verifyDrawable(drawable));
    }
