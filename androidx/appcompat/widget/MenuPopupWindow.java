...
public final class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public ProfileCache mHoverListener;
    ...
    public final void onItemHoverEnter(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
        ProfileCache profileCache = this.mHoverListener;
        if (profileCache != null) {
            profileCache.onItemHoverEnter(menuBuilder, menuItemImpl);
        }
    }
    ...
    public final void onItemHoverExit(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
        ProfileCache profileCache = this.mHoverListener;
        if (profileCache != null) {
            profileCache.onItemHoverExit(menuBuilder, menuItemImpl);
        }
    }
}
